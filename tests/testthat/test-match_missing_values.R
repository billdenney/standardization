test_that("match_missing_values works", {
  ...
  match_values_1<-match_missing_values(source<-data.frame(col1=c(2,3,"NA","","<3.5","2015-04-06",
  ...
  match_values_2<-suppressWarnings(match_missing_values(source<-data.frame(col1=c(2,3,"NA",1,"<3.5","2015-04-06",
                                                                                  "XYZ","2015-04-06T09:10",
                                                                                  "Cycle 1")),
  ...
  expect_warning(match_missing_values(source<-data.frame(col1=c(2,3,"NA","","<3.5","2015-04-06",
                                                                "XYZ","2015-04-06T09:10",
                                                                "Cycle 1")),
                                      output<-data.frame(col1=c(2,3,"NA","","<3.5","2015-04-06T",
                                                                "XYZ dosing","2015-04-06 09:10",
                                                                "Cycle 1"))),NA)
  expect_warning(match_missing_values(source<-data.frame(col1=c(2,3,"NA",1,"<3.5","2015-04-06",
                                                                "XYZ","2015-04-06T09:10",
                                                                "Cycle 1")),
                                      output<-data.frame(col1=c(2,3,"NA",NA,"<3.5","2015-04-06T",
                                                                "XYZ dosing","2015-04-06 09:10",
